    ...
    <div className="cm-ai-page">
      ...
      <div className={`cm-ai-layout ${sidebarOpen ? "menu-open" : ""}`}>
        ...
        <main className="cm-ai-main">
          ...
          <div className="cm-ai-input-area">
            <form className="cm-ai-input-form" onSubmit={submit}>
              <input
                type="text"
                ...
                disabled={sending}
              />
              <button type="submit" disabled={sending} className="cm-ai-send-btn">
                <Send size={18} />
              </button>
            </form>
          </div>
